...
public class JAVFileMenu extends FileMenu {

	private static final Logger logger = Logger.getLogger(JAVFileMenu.class.getPackage().getName());

	public JAVFileMenu(JAVController controller) {
		super(controller);
	}
	...
	public class SaveModifiedAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent event) {
			getJAVController().reviewModifiedResources();
		}
	}
